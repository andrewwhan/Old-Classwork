...
static int __init interceptor_start(void) {
	...
	printk(KERN_EMERG "Loaded interceptor!");
...
static void __exit interceptor_end(void) {
	...
	printk(KERN_EMERG "Unloaded interceptor!");
}	// static void __exit interceptor_end(void)
